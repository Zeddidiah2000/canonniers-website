...
(function () {
  ...
  var css = [
    ...
    ".partners-band .faux{display:flex;flex-direction:column;align-items:center;gap:6px;text-align:center;}",
    ".partners-band .faux-glyph{width:22px;height:22px;background:var(--navy);display:block;flex:none;}",
    ".partners-band .faux-name{font-family:'Barlow Condensed',sans-serif;font-weight:700;text-transform:uppercase;letter-spacing:0.06em;color:var(--navy-mid);line-height:1.05;font-size:11.5px;}",
    ".partners-band .shape-circle{border-radius:50%;}",
    ".partners-band .shape-rounded{border-radius:7px;}",
    ".partners-band .shape-square{border-radius:2px;}",
    ".partners-band .shape-diamond{border-radius:3px;transform:rotate(45deg) scale(0.82);}",
    ".partners-band .shape-hex{clip-path:polygon(25% 5%,75% 5%,100% 50%,75% 95%,25% 95%,0 50%);}",
    ".partners-band .shape-tri{clip-path:polygon(50% 8%,96% 92%,4% 92%);}",
